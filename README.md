...
- Inverse-map error evaluation (distance + velocity error plots)
...
Each eval figure is generated as two stacked subplots:
- top: distance error
- bottom: velocity error (relative-speed error)
